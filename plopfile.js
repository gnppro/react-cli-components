module.exports = plop => {
  plop.setGenerator('component', {
    ...
    actions: [
      {
        type: 'add',
        path: 'src/components/templates/{{pascalCase name}}/{{pascalCase name}}.jsx',
        templateFile:
          'plop-templates/Component/Component.jsx.hbs',
      },
      {
        type: 'add',
        path: 'src/components/templates/{{pascalCase name}}/{{pascalCase name}}.test.js',
        templateFile:
      ...
      },
      {
        type: 'add',
        path:
          'src/components/templates/{{pascalCase name}}/{{pascalCase name}}.scss',
        templateFile:
